...
<Grid item xs={12} lg={6}>
      ...
      transition={{ duration:3 }}>
         <img src="/assets/images/home-chooseus.jpg" alt="" style={{width:'100%'}}/>
        </motion.div>
        </Grid>
        <Grid item xs={12} lg={6}>
      ...
      transition={{ duration:3 }}>
          ...
          <Typography variant="h2" sx={{color:'#000'}}>Why Choose us</Typography>
...
In the tapestry of  story, every thread is woven with the spirit of redefining possibilities. Our journey is not merely a trajectory of growth a symphony of ideation, a canvas where each stroke of creativity adds a new layer to the ever-evolving landscape of innovation.
